...
export default function Page() {
  ...
  const showHeader = view !== 'home' && view !== 'shared-trip-view' && view !== 'forgot-password' && view !== 'admin-login' && view !== 'admin-dashboard'
  const showFooter = view !== 'home' && view !== 'shared-trip-view' && view !== 'forgot-password' && view !== 'admin-login' && view !== 'admin-dashboard'
