  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user.role !== 'DRIVER') {
        toast.error('Ce compte n\'est pas un compte chauffeur')
        return
      }
    ...
    <div className="flex-1 flex items-center justify-center px-4 py-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-[#FFD700]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <span className="text-4xl">🚕</span>
          </div>
          <h2 className="text-2xl font-bold text-[#006233]">Connexion Chauffeur</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 h-16 rounded-2xl text-2xl text-center font-semibold tracking-wider border-2 border-gray-200 focus:border-[#FFD700]"
              value={phone}
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-12 h-16 rounded-2xl text-xl text-center font-semibold border-2 border-gray-200 focus:border-[#FFD700]"
              value={password}
        ...
        <div className="text-center">
          <button
            ...
            className="text-sm text-gray-400 hover:text-[#006233] transition-colors"
          >
            Mot de passe oublié ?
          </button>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            Pas de compte ?{' '}
            <button
              onClick={() => setView('driver-register')}
        ...
        <div className="mt-4 p-3 bg-amber-50 rounded-2xl border border-amber-200">
          <p className="text-xs text-amber-700 text-center">
            📱 Compte test : <strong>77 123 45 67</strong>
          </p>
        </div>
      </div>
    </div>
